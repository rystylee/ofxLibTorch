...
class VGG16 final : public ofxLibTorch::BaseModel
{
public:
    VGG16();
    ...
    std::pair<int, float> forward(const ofFbo& inputFbo)
    {
        ...
        at::Tensor inputTensor = ofx::libtorch::util::fboToFloatTensor(inputFbo, *mDevice.get());
    ...
    std::pair<int, at::Tensor> forward(const ofFloatPixels& inputPixel)
    {
        ...
        at::Tensor inputTensor = ofx::libtorch::util::floatPixelsToFloatTensor(inputPixel, *mDevice.get());
